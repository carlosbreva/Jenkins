...
public class Liga {
    ...
    public static Liga crearLiga(String nombreLiga, Paises pais){
        String Entrenadores = "Documentos_Ligas/" + nombreLiga + "/Entrenadores_" + nombreLiga + ".txt";
        String Porteros = "Documentos_Ligas/" + nombreLiga + "/Porteros_" + nombreLiga + ".txt";
        String Jugadores = "Documentos_Ligas/" + nombreLiga + "/RestoDeJugadores_" + nombreLiga + ".txt";
        String Nombres_Equipos = "Documentos_Ligas/" + nombreLiga + "/Equipos_" + nombreLiga + ".txt";
